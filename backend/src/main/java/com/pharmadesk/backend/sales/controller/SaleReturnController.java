...
import com.pharmadesk.backend.sales.service.ReturnService;
...
public class SaleReturnController {
    ...
    @GetMapping("/pending")
    public ResponseEntity<ApiResponse<List<com.pharmadesk.backend.sales.model.MedicineReturn>>> getPendingReturns() {
        return ResponseEntity.ok(ApiResponse.success(returnService.getPendingReturns(), "Pending returns fetched"));
    }

    @GetMapping
    public ResponseEntity<ApiResponse<List<com.pharmadesk.backend.sales.model.MedicineReturn>>> getAllReturns() {
